...
class ExportTaxExpenseHistories implements FromCollection, WithColumnWidths, WithHeadings, WithCustomStartCell, WithEvents
{
     ...
     public function __construct($export_data)
    {
        ...
        foreach ($export_data as $value) {
            ...
            $dataExport[] = [
                ...
                "amount_usd3"                => "\t" . $value->ge_tax_usd,
                "amount_kh3"                 => "\t" . $value->te_tax_income,
                "amount_usd4"                => "\t" . $value->ge_total_cost_usd,
                "amount_kh4"                 => "\t" . $value->ge_total_cost_riel,
                "amount_usd5"                => "\t" . $value->ge_vat_reverse_charge_usd,
                "amount_kh5"                 => "\t" . $value->vat_reverse_charge_riel,
                "amount_usd6"                => "\t" . $value->ge_total_amount_usd,
                "amount_kh6"                 => "\t" . $value->te_total_tax,
