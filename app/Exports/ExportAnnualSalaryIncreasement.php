...
class ExportAnnualSalaryIncreasement implements FromCollection, WithColumnWidths, WithHeadings, WithCustomStartCell, WithEvents
{
     ...
     public function __construct($export_data)
    {
        ...
        foreach ($export_data as $value) {
            ...
            $dataExport[] = [
                ...
                "total_score_live_staff"        =>$value->total_score_live_staff,
                "total_score_direct_chairman"   =>$value->total_score_direct_chairman,
                "salary_increasement"           =>$value->salary_increasement,
                "salary_request"                =>$value->salary_request,
