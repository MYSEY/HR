$(document).ready(function() {
    ...
    $("." + buttonSubmit).on("click", function() {
        ...
        if (num_miss>0) {
            ...
            form_data.append("ge_tax_usd", getVal("exp_tax_declaration_dollar"));
            form_data.append("te_tax_income", getVal("exp_tax_declaration_rial"));
            ...
            form_data.append("te_total_tax", getVal("exp_total_paid_rial"));
...
function totalPaidDollar(){
    ...
    if (total_cost_dollar) {
        total_paid = parseFloat(total_cost_dollar) + total_cost;
    }

    $("#exp_total_paid_dollar").val(total_paid);
...
function totalPaidRial(){
    ...
    let total_cost = 0;
        ...
        $("#exp_total_paid_rial").val(total_paid);
