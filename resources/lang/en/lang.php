...
return[
    ...
    "generate_pay_motor"=>"Generate pay motor",
    ...
    "motor_rentals"=>"Motor Rental Payment",
    "motor_rental"=>"Motor Rental",
    "motor_rental_reports"=>"Motor rental reports",
    "motor_rental_review"=>"Motor rental review",
    ...
    "total_(motor_&_tablets)"=>"Total (Motor & Tablets)",
    "twitter"=>"Twitter",
