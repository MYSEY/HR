...
return[
    ...
    "add_amount_approval"=>"Add amount approval",
    ...
    "serialref"=>"Serialref",
    "selected_items_must_have_the_same_status"=>"Selected items must have the same status",
    "selected_items_must_have_the_same_type"=>"Selected items must have the same type",
    ...
    "active"=>"Active",
    "asign_to"=>"Assign To",
    "asign_to_position"=>"Assign to position",
	...
	"asign_to_employee"=>"Assign To Employee",
	"accepted"=>"Accepted",
    ...
    "fn_amount_usd"=>"Amount USD",
    "fn_amount_khr"=>"Amount KHR",
    "fn_created_at"=>"Creation Date",
    "fn_taxes"=>"FN Taxes",
    "fn_type"=>"Type",
    "fn_tax"=>"FN Tax",
    "fn_payment_term"=>"FN Payment term",
    "fn_level_reviewer"=>"FN Level Reviewer",
    "fn_regular_expense"=>"FN Contract Upload",
    "fn_exchange_rate"=>"Equivalence Exchange",
    "google"=>"Google",
    "goods_or_materials"=>"1. Goods or Materials",
    "groups"=>"Groups",
    "group"=>"Group",
    "gender"=>"Gender",
    "grade"=>"Grade",
    ...
    "import_result"=>"Import result PA",
    ...
    "kh"=>"KH",
    "kpi_process"=>"KPI Review Process",
    ...
    "labor_fee/services/sthers"=>"2. Labor Fee/Services/Others",
    "log_in"=>"Log In",
    "log_out"=>"Log Out",
    "login"=>"Log In",
    ...
    "staff_leave_report"=>"Staff Leave Report",
    ...
    "non_fixed_asset"=>"Non fixed asset",
    ...
    "paid"=>"Paid", 
    "paid_date"=>"Paid Date", 
    "paid_to_supplier(USD)"=>"Paid to Supplier (USD)", 
    "paid_to_supplier(KHR)"=>"Paid to Supplier (KHR)", 
    "paid_to_supplier(4)"=>"5. Paid to Supplier(4)", 
    "paid_to_supplier(3)or(3-(4+5))"=>"6. Paid to Supplier(3) or (3-(4+5))", 
    "pa_process"=>"PA Process",
    "pa_report"=>"PA Report",
    "password"=>"Password",
    "passport"=>"Passport",
    ...
    "pa_flow"=>"PA Flow",
    "pa_level_reviewer"=>"PA Set Up Level",
    "pa_level_review"=>"PA level review",
    "pdf"=>"PDF",
    ...
    "please_select_the_type_of_replace_employee"=>"Please select the type of replace employee for approved",
	...
	"please_select_payment_by_or_Other"=> "Please select payment by or Other",
	"please_select_item_befor_delete"=> "Please select item befor delete",
	"please_select_any_checkbox_to_request"=> "Please select any checkbox to request.",
    ...
    "performance_appraisal"=>"PA Management",
    ...
    "register"=>"Register",
    "reg_exp_ssd_upload"=>"Reg exp SSD upload",
    ...
    "request_by_location"=>"Request By Location",
    ...
    "salary_increasement"=>"Salary Increasement",
    "to"=>"To",
    "to_"=>"To",
    "to_amount"=>"To Amount",
    "time"=>"Time",
    ...
    "tax_declaration_expenses"=>"3. Tax declaration expenses",
    ...
    "total_expense"=>"3. Total Expense",
    "total_expense(១+២+៣)"=>"4. Total expense (១+២+៣)",
    ...
    "vat_reverse_charge_10"=>"5. VAT Reverse Charge 10%",
    ...
    "you_cannot_aprove"=>"You cannot approve",
    "you_cannot_approve"=>"You cannot approve",
    // monthly
    "january" => "January",
    "february" => "February",
    "march" => "March",
    ...
    "object" => "Object",
    "october" => "October",
    "or_tax_on_fring_benefit" => "Or Tax on Fring Benefit",
    "november" => "November",
    "december" => "December",
];