    ...
    <div class="">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">@lang('lang.inter-failed')</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/dashboad/employee')}}">@lang('lang.dashboard')</a></li>
                        <li class="breadcrumb-item active">@lang('lang.inter-failed')</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-striped custom-table no-footer tbl-failed"
...
<script type="text/javascript">
    ...
    function showDatas() {
        ...
        if ($.fn.DataTable.isDataTable('.tbl-failed')) {
            $('.tbl-failed').DataTable().clear().destroy();
        }

        $('.tbl-failed').DataTable({
            processing: true,
            serverSide: true,
            pageLength: 10,
            lengthMenu: [
            ...
            columns: [
                ...
                /* ===== STATUS COLUMN ===== */
                {
                    ...
                    render: function (staff) {
                        ...
                        if (staff.interviewed_result == "7") {
                            if (staff.joined_interview == "1") {
                                return '<span class="badge bg-inverse-success">@lang("lang.yes")</span>';
                            } else if (staff.joined_interview == "2") {
                                return '<span class="badge bg-inverse-danger">@lang("lang.no")</span>';
                            }
                        }
                        ...
                        let btn = `
                            <a class="btn btn-white btn-sm btn-rounded">
                                ...
                                <span>@lang("lang.interviewed")</span>
                            </a>
                        `;
                ...
                /* ===== RESULT ===== */
                {
                    ...
                    render: function (val) {
                        switch (val) {
                            case "2": return "@lang('lang.failed')";
                            case "5": return "@lang('lang.high_exected_salary')";
                            case "6": return "@lang('lang.rejected_offered')";
                            case "7": return '<span class="badge bg-inverse-danger">@lang("lang.black_list")</span>';
                            case "8": return "@lang('lang.non_black_list')";
                            default:  return "No";
                        }
                    }
                },
