    ...
    <div class="card-header">
        ...
        <div style="display: flex">
            <div style="margin-left: 30%;text-align: center">
                ...
                <label class="title">ការរក្សាការសម្ងាត់វិជ្ជាជីវៈ</label><br>
        ...
        <div style="display:flex;" class="set-font">
            <div style="width: 487%;">
                <table style="width:100%">
                    <tr>
                        <td class="table_tr">
                            ១-	<strong>និយោជកៈ</strong> គ្រឹះស្ថាន ខេមា មីក្រូហិរញ្ញវត្ថុ លីមីតធីត អាស័យដ្ឋានផ្ទះលេខ ១០១A ផ្លូវ ២៨៩ សង្កាត់ បឹងកក់ទី១ ខណ្ឌទួលគោក រាជធានីភ្នំពេញ និងអាជ្ញាប័ណ្ណលេខ ម.ហ ២៤ (M.F 24) ចុះថ្ងៃទី២៦ ខែវិច្ឆិកា ឆ្នាំ២០១២  តំណាងដោយលោក <strong>លី ឈាង</strong> តួនាទីអគ្គនាយកប្រតិបតិ្តស្តីទី ដែលតទៅនេះហៅថា “និយោជក”។
                        </td>
                    </tr>
                </table>
