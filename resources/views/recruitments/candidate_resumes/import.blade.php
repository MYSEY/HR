<div id="import_motor_cv" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('lang.import_new_candidate_cv')</h5>
    ...
    $(function() {
        ...
        $(".upload_file_data").on("click", function() {
            ...
            if (fileExtension == "xls" || fileExtension == "xlsx" || fileExtension == "csv" && fileSize < 1048576) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('recruitment/candidate-resume/import') }}",
                    data: form_data,
                    contentType: false,
                    cache: false,
                    processData: false,
