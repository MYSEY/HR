<div id="importCommuneModal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('lang.import_commune')</h5>
            ...
            if (fileExtension == "xls" || fileExtension == "xlsx" || fileExtension == "csv" && fileSize < 1048576) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            $("#importCommuneModal").modal("hide");
                            toastr.success('Data has been save success');
                            window.location.replace("{{ URL('commune') }}");
                        }
                        if (data == 2) {
                            $("#importCommuneModal").modal("hide");
