                                                ...
                                                @if (count($data)>0)
                                                    @foreach ($data as $key=>$item)
                                                        <tr class="odd">
                                                            ...
                                                            <td class="text-end">
                                                                @if (permissionAccess("m11-s3","is_update")->value == "1" || permissionAccess("m11-s3","is_delete")->value == "1")
                                                                    <div class="dropdown dropdown-action">
                                                                        <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            @if (permissionAccess("m11-s3","is_update")->value == "1")
                                                                            ...
                                                                            @endif
                                                                            @if (permissionAccess("m11-s3","is_delete")->value == "1")
