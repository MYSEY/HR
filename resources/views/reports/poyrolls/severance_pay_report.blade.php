...
<div class="">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">@lang('lang.severance_pay_report')</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">@lang('lang.dashboard')</a></li>
                    <li class="breadcrumb-item active">@lang('lang.severance_pay_report')</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="">
        @if (permissionAccess("28","is_view")->value == "1")
            <form>
                {{-- @csrf --}}
                <div class="row filter-btn"> 
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div style="display: flex" class="float-end">
                            ...
                            @if (permissionAccess("28","is_export")->value == "1")
...
<script>
    $(function() {
        $(".reset-btn").on("click", function() {
            ...
            window.location.replace("{{ URL('reports/severance-pay-report') }}");
        });
    ...
    function showdatas(params) {
        ...
        $.ajax({
            type: "post",
            url: "{{ url('reports/severance-pay-report') }}",
            data: {
                "_token": "{{ csrf_token() }}",
