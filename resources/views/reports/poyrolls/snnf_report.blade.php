...
<div class="">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">@lang('lang.nssf_report')</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">@lang('lang.dashboard')</a></li>
                    <li class="breadcrumb-item active">@lang('lang.nssf_report')</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="row filter-btn"> 
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div style="display: flex" class="float-end">
                            ...
                            @if (permissionAccess("m7-s4","is_export")->value == "1")
                                                    ...
                                                    @if (count($dataNSSF) > 0)
                                                        @foreach ($dataNSSF as $item)
                                                            <tr class="odd">
                                                                ...
                                                                <td>${{ round($item->pension_contribution_riel,2) }}</td>
