    ...
    <div class="">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">@lang('lang.performance_appraisal_report')</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">@lang('lang.dashboard')</a></li>
                        <li class="breadcrumb-item active">@lang('lang.performance_appraisal_report')</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(function(){
            $(".btn_excel").on("click", function() {
                ...
                var url = "{{URL::to('performance/appraisal/pa-export')}}?" + $.param(query)
                window.location = url;
            });
            ...
            $(".reset-btn").on("click", function() {
                ...
                window.location.replace("{{ URL('performance/appraisal/pa-report') }}");
            });
        });
        ...
        function dataTables() {
            ...
            $('#DataTables_Table_0').DataTable({
                ...
                ajax: {
                    url: '{{ URL("performance/appraisal/pa-report") }}',
                    type: 'GET',
                    data: function (d) {
