            ...
            <form class="was-validated">
                ...
                <hr>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-10">
                        <label class="container-checkbox">@lang('lang.all')
                            <input type="checkbox" id="leave_all" name="leave_all"
                            {{SetCheckbox($arrayPermissions,"lang.leave","is_all")->checkbox}}
                            value="{{SetCheckbox($arrayPermissions,"lang.leave","is_all")->value}}"
                            > <span class="checkmark"></span>
                        </label>
                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-2">
                                <label class="container-checkbox">@lang('lang.leaves_admin')
                                    <input type="checkbox" class="leave_checkbox" id="leaves_admin"
                                    > <span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-4">
                                <label class="container-checkbox">@lang('lang.view')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_view"
                                ...
                                <label class="container-checkbox">@lang('lang.add')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_add" 
                                ...
                                <label class="container-checkbox">@lang('lang.edit')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_edit" 
                            ...
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.delete')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_delete" 
                                ...
                                <label class="container-checkbox">@lang('lang.approve')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_approve" 
                                ...
                                <label class="container-checkbox">@lang('lang.reject')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_reject" 
                            ...
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.cancel')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_cancel"
                                    {{SetCheckbox($arrayPermissions,"lang.leaves_admin","is_cancel")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leaves_admin","is_cancel")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.print')
                                    <input type="checkbox" class="leave_checkbox leaves_admin_checkbox" id="leaves_admin_print" 
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="container-checkbox">@lang('lang.view')
                                    <input type="checkbox" class="leave_checkbox leaves_employee_checkbox" id="leaves_employee_view" 
                                ...
                                <label class="container-checkbox">@lang('lang.add')
                                    <input type="checkbox" class="leave_checkbox leaves_employee_checkbox" id="leaves_employee_add" 
                                ...
                                <label class="container-checkbox">@lang('lang.edit')
                                    <input type="checkbox" class="leave_checkbox leaves_employee_checkbox" id="leaves_employee_edit" 
                            ...
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.delete')
                                    <input type="checkbox" class="leave_checkbox leaves_employee_checkbox" id="leaves_employee_delete" 
                                ...
                                <label class="container-checkbox">@lang('lang.cancel')
                                    <input type="checkbox" class="leave_checkbox leaves_employee_checkbox" id="leaves_employee_cancel" 
                            ...
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.print')
                                    <input type="checkbox" class="leave_checkbox leaves_employee_checkbox" id="leaves_employee_print" 
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="container-checkbox">@lang('lang.view')
                                    <input type="checkbox" class="leave_checkbox leave_report_checkbox" id="leave_report_view" 
                                    {{SetCheckbox($arrayPermissions,"lang.leaves_report","is_view")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leaves_report","is_view")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.print')
                                    <input type="checkbox" class="leave_checkbox leave_report_checkbox" id="leave_report_print" 
                                    {{SetCheckbox($arrayPermissions,"lang.leaves_report","is_print")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leaves_report","is_print")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.export')
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <label class="container-checkbox">@lang('lang.all')
                            <input type="checkbox" id="performace_all" name="performace_all"
                            {{SetCheckbox($arrayPermissions,"lang.performance_management","is_all")->checkbox}}
                            value="{{SetCheckbox($arrayPermissions,"lang.performance_management","is_all")->value}}"
                            ><span class="checkmark"></span>
                        </label>
                    </div>
                    {{-- block performance --}}
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="container-checkbox">@lang('lang.view')
                                    <input type="checkbox" class="performance_checkbox p_checkbox" id="p_view"
                                    {{SetCheckbox($arrayPermissions,"lang.performance","is_view")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance","is_view")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.add')
                                    <input type="checkbox" class="performance_checkbox p_checkbox" id="p_add"
                                    {{SetCheckbox($arrayPermissions,"lang.performance","is_create")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance","is_create")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.edit')
                                    <input type="checkbox" class="performance_checkbox p_checkbox" id="p_edit"
                                    {{SetCheckbox($arrayPermissions,"lang.performance","is_update")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance","is_update")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.delete')
                                    <input type="checkbox" class="performance_checkbox p_checkbox" id="p_delete" 
                                    {{SetCheckbox($arrayPermissions,"lang.performance","is_delete")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance","is_delete")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.approve')
                                    <input type="checkbox" class="performance_checkbox p_checkbox" id="p_approve"
                                    {{SetCheckbox($arrayPermissions,"lang.performance","is_approve")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance","is_approve")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.export')
                                    <input type="checkbox" class="performance_checkbox p_checkbox" id="p_export"
                                    {{SetCheckbox($arrayPermissions,"lang.performance","is_export")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance","is_export")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-2">
                                <label class="container-checkbox">@lang('lang.performance_review')
                                    <input type="checkbox" class="performance_checkbox" id="performance_review" name="performance_review"> <span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-4">
                                <label class="container-checkbox">@lang('lang.view')
                                    <input type="checkbox" class="performance_checkbox pr_checkbox" id="pr_view"
                                    {{SetCheckbox($arrayPermissions,"lang.performance_review","is_view")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance_review","is_view")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.add')
                                    <input type="checkbox" class="performance_checkbox pr_checkbox" id="pr_add"
                                    {{SetCheckbox($arrayPermissions,"lang.performance_review","is_create")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance_review","is_create")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.edit')
                                    <input type="checkbox" class="performance_checkbox pr_checkbox" id="pr_edit"
                                    {{SetCheckbox($arrayPermissions,"lang.performance_review","is_update")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance_review","is_update")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.delete')
                                    <input type="checkbox" class="performance_checkbox pr_checkbox" id="pr_delete"
                                    {{SetCheckbox($arrayPermissions,"lang.performance_review","is_delete")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance_review","is_delete")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label class="container-checkbox">@lang('lang.approve')
                                    <input type="checkbox" class="performance_checkbox pr_checkbox" id="pr_approve"
                                    {{SetCheckbox($arrayPermissions,"lang.performance_review","is_approve")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance_review","is_approve")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.export')
                                    <input type="checkbox" class="performance_checkbox pr_checkbox" id="pr_export"
                                    {{SetCheckbox($arrayPermissions,"lang.performance_review","is_export")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.performance_review","is_export")->value}}"
                                    ><span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <label class="container-checkbox">@lang('lang.leave_type')
                                    <input type="checkbox" class="configuration_checkbox" id="leave_type"> <span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-2">
                                <label class="container-checkbox">@lang('lang.view')
                                    <input type="checkbox"class="configuration_checkbox leave_type_checkbox" id="leave_type_check_view"
                                    {{SetCheckbox($arrayPermissions,"lang.leave_type","is_view")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leave_type","is_view")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.add')
                                    <input type="checkbox"class="configuration_checkbox leave_type_checkbox" id="leave_type_check_add"
                                    {{SetCheckbox($arrayPermissions,"lang.leave_type","is_create")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leave_type","is_create")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.edit')  
                                    <input type="checkbox"class="configuration_checkbox leave_type_checkbox" id="leave_type_check_edit"
                                    {{SetCheckbox($arrayPermissions,"lang.leave_type","is_update")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leave_type","is_update")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                                <label class="container-checkbox">@lang('lang.delete')
                                    <input type="checkbox"class="configuration_checkbox leave_type_checkbox" id="leave_type_check_delete"
                                    {{SetCheckbox($arrayPermissions,"lang.leave_type","is_delete")->checkbox}}
                                    value="{{SetCheckbox($arrayPermissions,"lang.leave_type","is_delete")->value}}"
                                    > <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
