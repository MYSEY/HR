...
<script>
    $(function(){
        ...
        $("#e_start_date").on("dp.change", function(e) {
            ...
            // ១. កំណត់ e.date ត្រឹម 00:00:00 ដើម្បីកុំឲ្យទាក់ time
            let startDates = e.date.clone().startOf('day');
            
            // ២. Update minDate ទៅកាន់ e_end_date
            let endDatePicker = $('#e_end_date').data('DateTimePicker');
            if (endDatePicker) {
                endDatePicker.minDate(startDates);
                
                // បើសិន e_end_date បច្ចុប្បន្ន តូចជាង e_start_date ថ្មី ត្រូវ Set វាឲ្យស្មើ e_start_date
