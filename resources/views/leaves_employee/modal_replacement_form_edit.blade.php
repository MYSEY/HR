    ...
    <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <input hidden type="text" id="e_employee_id">
                    <div class="row">
                        <div class="col-sm-12">
    ...
    $(function(){
        ...
        $('.update').on('click',function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#e_employee_id').val(success.employee_id);
                    ...
                    if (response.dataLeaveType != '') {
                        $.each(response.dataLeaveType, function(i, item) {
                            $('#e_leave_type_id').append($('<option>', {
                                ...
                                disabled: item.id != response.success.leave_type_id
                            }));
                        });
                    }
        ...
        $(".btn-e-apply").on("click", function() {
            ...
            if (num_miss>0 || $("#e_number_of_day").val() == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('leaves/replacement/update')}}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "id":  $("#e_id_leave").val(),
