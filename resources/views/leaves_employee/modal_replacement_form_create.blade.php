                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group hr-form-group-select2">
                                ...
                                <select class="hr-select2-option requered leave_required" id="employee_id" name="employee_id" required>
    ...
    $(function(){
        ...
        $(".btn-apply").on("click", function() {
            ...
            if ($("#employee_id").val() ==null || $("#employee_id").val() =="") {
                ...
                new Noty({
                    title: "",
                    text: "Please check input employee required",
                    type: "error",
                    timeout: 3000,
                    icon: true
                }).show();
            ...
            if (num_miss>0 || $("#number_of_day").val() == 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('leaves/replacement/store')}}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                    ...
                    success: function (response) {
                        if (response.status == 404) {
                            ...
                            window.location.replace("{{ URL('leaves/replcement') }}");
                        }
