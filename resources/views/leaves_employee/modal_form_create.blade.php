    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('lang.add_new_leave_request')</h5>
...
<script>
    $(function(){
        ...
        $("#start_date").on("dp.change", function(e) {
            ...
            // ១. កំណត់ startDates ត្រឹម 00:00:00 ដើម្បីកុំឲ្យទាក់ Time
            let startDates = e.date.clone().startOf('day');
            
            // ២. Update minDate ទៅកាន់ end_date
            var endDatePicker = $('#end_date').data('DateTimePicker');
            if (endDatePicker) {
                endDatePicker.minDate(startDates);
                
                // បើសិន end_date បច្ចុប្បន្ន តូចជាង start_date ថ្មី ត្រូវ Set វាឲ្យស្មើ start_date
        ...
        $("#end_date").on("dp.change", function(e) {
            ...
            let startDateMoment = $('#start_date').data('DateTimePicker') ? $('#start_date').data('DateTimePicker').date() : null;
            let endDateMoment = e.date;

            // ប្រៀបធៀបតែ Date (មិនគិត Time)
