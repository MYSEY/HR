    ...
    <div class="">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">@lang('lang.user_not_login')</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">@lang('lang.dashboard')</a></li>
                        <li class="breadcrumb-item active">@lang('lang.user_not_login')</li>
                    </ul>
                </div>
            </div>
        </div>
                                                ...
                                                @if (count($data)>0)
                                                    @foreach ($data as $key=>$item)
                                                        <tr class="odd">
                                                            ...
                                                            <td><span style="font-size: 13px" class="badge bg-inverse-success">Not Login</span></td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                            </tbody>
