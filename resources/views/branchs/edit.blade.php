        ...
        <div class="card">
            <div class="card-body">
                <div class="modal-body">
                    <form action="{{route('branch.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label>Name (KH) <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="branch_name_kh" value="{{$data->branch_name_kh}}">
                            <p class="text-danger">{!! $errors->first('branch_name_kh') !!}</p>
                        </div>
                        <div class="form-group">
                            <label>Name (EN) <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="branch_name_en" value="{{$data->branch_name_en}}">
