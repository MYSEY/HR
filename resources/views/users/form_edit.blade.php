        ...
        <div class="card card_background_color">
            <div class="card-body">
                <form action="{{url('users/update')}}" method="POST" enctype="multipart/form-data"  class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="e_number_employee" readonly name="number_employee" value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    {{-- basic salary infor --}}
                    @if (permissionAccess("m2-s1","is_view_salary")->value == "1" && permissionAccess("m2-s1", "is_view_salary_staff")->value == "1")
