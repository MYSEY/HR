...
@section('content')
                                        ...
                                        <table class="table table-striped custom-table mb-0 datatable dataTable no-footer btn_trainer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Company Name: activate to sort column ascending" style="width: 772.237px;">@lang('lang.srok_name_km')</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Name (KH): activate to sort column ascending" style="width: 772.237px;">@lang('lang.srok_name_latin')</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Name (EN): activate to sort column ascending" style="width: 772.237px;">@lang('lang.srok_name_en')</th>
                                                ...
                                                @if (count($data)>0)
                                                    @foreach ($data as $key=>$item)
                                                        <tr class="odd">
                                                            ...
                                                            <td>{{$item->code}}</td>
                                                            <td>{{$item->srok_name_km}}</td>
                                                            <td>{{$item->srok_name_latin}}</td>
                                                            <td>{{$item->srok_name_en}}</td>
                                                            <td>{{$item->name_km}}</td>
                                                            ...
                                                            <td class="text-end">
                                                                @if (permissionAccess("m11-s2","is_update")->value == "1" || permissionAccess("m11-s2","is_delete")->value == "1")
                                                                    <div class="dropdown dropdown-action">
                                                                        <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            @if (permissionAccess("m11-s2","is_update")->value == "1")
                                                                            ...
                                                                            @endif
                                                                            @if (permissionAccess("m11-s2","is_delete")->value == "1")
    ...
    @include('district.import')
@endsection
@include('includs.script')

<script>
    $(function(){
        $("#importDistrict").on("click", function() {
            $(".thanLess").hide();
            $("#thanLess").text("");
            $('#importDistrictModal').modal('show');
        });
    });
</script>