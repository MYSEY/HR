<div id="TrainingModalUpdate" class="modal custom-modal fade" aria-hidden="true" data-bs-backdrop="static">
            ...
            <div class="modal-body">
                <form action="{{url('employee/training/update')}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" spellcheck="false" id="e_descritions" name="descrition" style="position: relative;"></textarea>
                    </div>
                    <div class="submit-section">
                        <input type="hidden" name="id" id="e_train_id" value="">
