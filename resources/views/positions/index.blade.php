        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-end ms-auto">
                    <a href="{{url('/position/create')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped custom-table mb-0 datatable dataTable no-footer"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Department Name: activate to sort column ascending" style="width: 772.237px;">Created By</th>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="{{route('position.edit',$item->id)}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
