<div id="importProvinceModal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('lang.import_province')</h5>
            ...
            if (fileExtension == "xls" || fileExtension == "xlsx" || fileExtension == "csv" && fileSize < 1048576) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            $("#importProvinceModal").modal("hide");
                            toastr.success('Data has been save success');
                            window.location.replace("{{ URL('province') }}");
                        }
                        if (data == 2) {
                            $("#importProvinceModal").modal("hide");
