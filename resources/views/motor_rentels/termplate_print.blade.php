                ...
                <table class="table-font">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span class="float-end">$ {{ number_format($data->amount_price_motor_rentel, 2) }}</span>
                            </td>
                            <td>@lang('lang.motor_rental_fee_tax') ({{$data->tax_rate}}%) : </td>
                            <td>
                                <span class="float-end">$ {{ number_format(($data->amount_price_motor_rentel * $data->tax_rate) / 100, 2) }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>@lang('lang.gross_taplab_fee') ($): </td>
                            <td><span class="float-end">$ {{ number_format($data->amount_price_taplab_rentel, 2) }}</span></td>
                            <td>@lang('lang.taplab_fee_tax') ({{$data->tax_rate}}%) :</td>
                            <td>
                                <span class="float-end">$ {{ number_format(($data->amount_price_taplab_rentel * $data->tax_rate) / 100, 2) }}</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="tr-background-83">
                            ...
                            <td>
                                <span class="float-end">$ {{ number_format((($data->amount_price_taplab_rentel * $data->tax_rate) + ($data->amount_price_motor_rentel * $data->tax_rate)) / 100, 2) }}</span>
                            </td>
                        </tr>
                        <tr class="tr-background-83">
