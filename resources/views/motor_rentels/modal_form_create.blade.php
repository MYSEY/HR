                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control emp_required m_clear" type="text" id="motor_color" name="motor_color" value="{{old('motor_color')}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control emp_required m_clear" type="Number" id="shelt_life" name="shelt_life" value="{{old('shelt_life')}}" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control m_clear" type="text" name="taplab_imei" id="taplab_imei">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="cal-icon">
                                    <input class="form-control datetimepicker m_clear" type="text" id="start_date_taplab" name="start_date_taplab">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
