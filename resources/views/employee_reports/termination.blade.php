                            ...
                            <table class="table table-striped custom-table mb-0 datatable dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="DOB: activate to sort column ascending" style="width: 81.0625px;">Resign Date</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="DOB: activate to sort column ascending" style="width: 81.0625px;">Resign Reason</th>
                                    ...
                                    @if (count($users)>0)
                                        @foreach ($users as $item)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-success btn-sm">{{ $item->emp_status == 4 ? "Termination" : ""}}</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
