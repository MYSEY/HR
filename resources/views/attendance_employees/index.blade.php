        ...
        <div class="row filter-row">
            ...
            <div class="col-sm-3">
                <div class="form-group form-focus select-focus focused">
                    <select class="select floating select2-hidden-accessible" data-select2-id="select2-data-1-v2ad"
                        tabindex="-1" aria-hidden="true">
                        <option data-select2-id="select2-data-3-ov48">-</option>
                        <option>Jan</option>
                        <option>Feb</option>
                        <option>Mar</option>
                        <option>Apr</option>
            ...
            <div class="col-sm-3">
                <div class="form-group form-focus select-focus focused">
                    <select class="select floating select2-hidden-accessible" data-select2-id="select2-data-4-y873"
                        tabindex="-1" aria-hidden="true">
                        <option data-select2-id="select2-data-6-lvel">-</option>
                        <option>2019</option>
                        <option>2018</option>
                        <option>2017</option>
                        <option>2016</option>
