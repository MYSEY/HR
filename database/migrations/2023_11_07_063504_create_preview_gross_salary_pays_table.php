...
return new class extends Migration
{
    /**
     * Run the migrations.
     * php artisan migrate:refresh --path=database/migrations/2023_11_07_063504_create_preview_gross_salary_pays_table.php
     *
     * @return void
     */
    public function up()
    {
        Schema::create('preview_gross_salary_pays', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('preview_gross_salary_pays');
    }
};
