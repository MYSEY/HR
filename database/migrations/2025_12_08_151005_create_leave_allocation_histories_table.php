...
return new class extends Migration
{
    /**
     * Run the migrations.
     *php artisan migrate:refresh --path=database/migrations/2025_12_08_151005_create_leave_allocation_histories_table.php
     * @return void
     */
    public function up()
    {
        Schema::create('leave_allocation_histories', function (Blueprint $table) {
            ...
            $table->string('default_long_sick_leave')->nullable();
