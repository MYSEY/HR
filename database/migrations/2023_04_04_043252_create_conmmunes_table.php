...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('conmmunes', function (Blueprint $table) {
            $table->id();
            $table->string('code')->nullable();
            $table->string('khum_name_km')->nullable();
            $table->string('khum_name_latin')->nullable();
            $table->string('khum_name_en')->nullable();
