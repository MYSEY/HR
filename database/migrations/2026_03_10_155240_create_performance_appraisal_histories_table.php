...
return new class extends Migration
{
    /**
     * Run the migrations.
     *php artisan migrate:refresh --path=database/migrations/2026_03_10_155240_create_performance_appraisal_histories_table.php
     * @return void
     */
    public function up()
    {
        Schema::create('performance_appraisal_histories', function (Blueprint $table) {
            ...
            $table->longText('points_change_develop_employee')->nullable();
            $table->longText('desires')->nullable();
